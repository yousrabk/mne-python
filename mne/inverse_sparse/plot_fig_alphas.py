...
f, (ax1, ax2) = plt.subplots(1, 2, sharey=True,
                                           figsize=(8, 4))
f.subplots_adjust(left=0.1, right=0.97, wspace=0.06, hspace=0.15,
				  bottom=0.15)
...
ax1.set_yticks((alphas_init[::3] * 100).astype(int))
# ax2.set_yticks([])
ax1.set_xlabel('number of iterations', fontsize=16)
ax2.set_xlabel('number of iterations', fontsize=16)
ax1.set_ylabel(r'initialisation of \lambda', fontsize=16)
